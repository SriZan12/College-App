...
public class SecondSemAdapterAttendance extends FirebaseRecyclerAdapter<StudentModel, SecondSemAdapterAttendance.BCASecondSemAttendanceViewHolder> {

    Context context;
    DatabaseReference databaseReference;
    String Attendance,Role;
    public SecondSemAdapterAttendance(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BCASecondSemAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BCA").child("BCASecondSem");
    ...
    @NonNull
    @Override
    public BCASecondSemAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BCASecondSemAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BCASecondSemAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BCASecondSemAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
