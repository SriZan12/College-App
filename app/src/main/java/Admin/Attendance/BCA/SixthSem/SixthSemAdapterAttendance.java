...
public class SixthSemAdapterAttendance extends FirebaseRecyclerAdapter<StudentModel, SixthSemAdapterAttendance.BCASixthSemAttendanceViewHolder> {

    Context context;
    DatabaseReference databaseReference;
    String Attendance,Role;

    public SixthSemAdapterAttendance(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BCASixthSemAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BCA").child("BCASixthSem");
    ...
    @NonNull
    @Override
    public BCASixthSemAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BCASixthSemAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BCASixthSemAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BCASixthSemAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
