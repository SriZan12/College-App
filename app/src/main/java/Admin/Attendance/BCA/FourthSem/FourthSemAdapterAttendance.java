...
public class FourthSemAdapterAttendance extends FirebaseRecyclerAdapter<StudentModel, FourthSemAdapterAttendance.BCAFourthSemAttendanceViewHolder> {

    Context context;
    DatabaseReference databaseReference;
    String Attendance,Role;

    public FourthSemAdapterAttendance(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BCAFourthSemAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BCA").child("BCAFourthSem");
    ...
    @NonNull
    @Override
    public BCAFourthSemAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BCAFourthSemAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BCAFourthSemAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BCAFourthSemAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
