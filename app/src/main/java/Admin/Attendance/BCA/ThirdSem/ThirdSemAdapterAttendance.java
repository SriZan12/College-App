...
public class ThirdSemAdapterAttendance extends FirebaseRecyclerAdapter<StudentModel, ThirdSemAdapterAttendance.BCAThirdSemAttendanceViewHolder> {
    ...
    public ThirdSemAdapterAttendance(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BCAThirdSemAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BCA").child("BCAThirdSem");
    ...
    @NonNull
    @Override
    public BCAThirdSemAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BCAThirdSemAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BCAThirdSemAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BCAThirdSemAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
