...
public class EightSemAdapterAttendance extends FirebaseRecyclerAdapter<StudentModel, EightSemAdapterAttendance.BCAEighthSemAttendanceViewHolder> {

    Context context;
    String Attendance,Role;
    DatabaseReference databaseReference;

    public EightSemAdapterAttendance(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BCAEighthSemAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BCA").child("BCAEightSem");
    ...
    @NonNull
    @Override
    public BCAEighthSemAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BCAEighthSemAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BCAEighthSemAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BCAEighthSemAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
