...
public class BBSSecondYearAttendanceAdapter extends FirebaseRecyclerAdapter<StudentModel, BBSSecondYearAttendanceAdapter.BBSSecondYearAttendanceViewHolder> {

    Context context;
    String Attendance,Role;
    DatabaseReference databaseReference;
    public BBSSecondYearAttendanceAdapter(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BBSSecondYearAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BBS").child("BBSecondYearAttendance");
    ...
    @NonNull
    @Override
    public BBSSecondYearAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BBSSecondYearAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BBSSecondYearAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BBSSecondYearAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
