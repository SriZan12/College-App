...
public class BBSFirstYearAttendanceAdapter extends FirebaseRecyclerAdapter<StudentModel, BBSFirstYearAttendanceAdapter.BBSFirstYearAttendanceViewHolder> {
    ...
    public BBSFirstYearAttendanceAdapter(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BBSFirstYearAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BBS").child("BBSFirstYearAttendance");
    ...
    @NonNull
    @Override
    public BBSFirstYearAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BBSFirstYearAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BBSFirstYearAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BBSFirstYearAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
