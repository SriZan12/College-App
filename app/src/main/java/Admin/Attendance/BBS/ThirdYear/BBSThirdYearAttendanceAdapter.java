...
public class BBSThirdYearAttendanceAdapter extends FirebaseRecyclerAdapter<StudentModel, BBSThirdYearAttendanceAdapter.BBSThirdYearAttendanceViewHolder> {

    Context context;
    String Attendance,Role;
    DatabaseReference databaseReference;
    public BBSThirdYearAttendanceAdapter(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BBSThirdYearAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BBS").child("BBSThirdYearAttendance");
    ...
    @NonNull
    @Override
    public BBSThirdYearAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BBSThirdYearAttendanceViewHolder (attendanceListDesignBinding,Role);
    }

    public static class BBSThirdYearAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BBSThirdYearAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
