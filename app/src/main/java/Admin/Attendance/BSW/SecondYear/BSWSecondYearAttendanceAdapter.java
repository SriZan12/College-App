...
public class BSWSecondYearAttendanceAdapter extends FirebaseRecyclerAdapter<StudentModel, BSWSecondYearAttendanceAdapter.BSWSecondYearAttendanceViewHolder> {

    Context context;
    DatabaseReference databaseReference;
    String Attendance,Role;

    public BSWSecondYearAttendanceAdapter(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BSWSecondYearAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BSW").child("BSWSecondYear");
    ...
    @NonNull
    @Override
    public BSWSecondYearAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BSWSecondYearAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BSWSecondYearAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BSWSecondYearAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
