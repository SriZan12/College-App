...
public class BSWThirdYearAttendanceAdapter extends FirebaseRecyclerAdapter<StudentModel, BSWThirdYearAttendanceAdapter.BSWThirdYearAttendanceViewHolder> {

    Context context;
    DatabaseReference databaseReference;
    String Attendance,Role;

    public BSWThirdYearAttendanceAdapter(@NonNull FirebaseRecyclerOptions<StudentModel> options, Context context, String role) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull BSWThirdYearAttendanceViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull StudentModel model) {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference("AttendanceStatus").child("BSW").child("BSWThirdYear");
    ...
    @NonNull
    @Override
    public BSWThirdYearAttendanceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        AttendanceListDesignBinding attendanceListDesignBinding = AttendanceListDesignBinding.inflate(layoutInflater);
        return new BSWThirdYearAttendanceViewHolder(attendanceListDesignBinding,Role);
    }

    public static class BSWThirdYearAttendanceViewHolder extends RecyclerView.ViewHolder {

        AttendanceListDesignBinding ListDesignBinding;
        String Role;

        public BSWThirdYearAttendanceViewHolder(AttendanceListDesignBinding attendanceListDesignBinding, String role) {
