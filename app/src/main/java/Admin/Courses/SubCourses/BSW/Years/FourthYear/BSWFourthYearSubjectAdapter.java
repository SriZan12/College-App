...
public class BSWFourthYearSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BSWFourthYearSubjectAdapter.BSWFourthYearSubjectViewHolder> {

    String Role;

    public BSWFourthYearSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWFourthYearSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BSWFourthYearSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding detailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BSWFourthYearSubjectViewHolder(detailsBinding);
    }

    public static class BSWFourthYearSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding detailsBinding;
        String Role;
        public BSWFourthYearSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
