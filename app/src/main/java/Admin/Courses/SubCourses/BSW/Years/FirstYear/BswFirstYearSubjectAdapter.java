...
public class BswFirstYearSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BswFirstYearSubjectAdapter.BswSubjectViewHolder> {

    String Role;
    public BswFirstYearSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull BswSubjectViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BswSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BswSubjectViewHolder(DetailsBinding);
    }

    public static class BswSubjectViewHolder extends RecyclerView.ViewHolder{

        SubjectDetailsBinding DetailsBinding;

        public BswSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
