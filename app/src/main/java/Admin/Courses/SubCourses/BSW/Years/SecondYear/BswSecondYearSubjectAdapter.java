...
public class BswSecondYearSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BswSecondYearSubjectAdapter.BswSecondSubjectViewHolder> {

    String Role;

    public BswSecondYearSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BswSecondSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BswSecondSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BswSecondSubjectViewHolder(DetailsBinding);
    }

    public static class BswSecondSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BswSecondSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
