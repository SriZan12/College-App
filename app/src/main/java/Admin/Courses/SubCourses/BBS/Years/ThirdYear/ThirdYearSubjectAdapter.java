...
public class ThirdYearSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, ThirdYearSubjectAdapter.ThirdYearStudent> {

    String Role;

    public ThirdYearSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull ThirdYearStudent holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public ThirdYearStudent onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new ThirdYearStudent(DetailsBinding);
    }

    public static  class ThirdYearStudent extends RecyclerView.ViewHolder{

        SubjectDetailsBinding DetailsBinding;
        public ThirdYearStudent(SubjectDetailsBinding subjectDetailsBinding) {
