...
public class FourthYearSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, FourthYearSubjectAdapter.FourthYearSubjectViewHolder> {

    String Sex,Role;

    public FourthYearSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull FourthYearSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public FourthYearSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new FourthYearSubjectViewHolder(DetailsBinding);
    }

    public static class FourthYearSubjectViewHolder extends RecyclerView.ViewHolder{

        SubjectDetailsBinding DetailsBinding;
        public FourthYearSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
