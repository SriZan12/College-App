...
public class SubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, SubjectAdapter.SubjectListViewHolder> {

    String Role;

    public SubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }
    ...
    public SubjectListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SubjectListViewHolder(DetailsBinding);
    }
