...
public class BCAFirstSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCAFirstSemSubjectAdapter.BCAFirstSemSubjectViewHolder> {

    String Role;

    public BCAFirstSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFirstSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCAFirstSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCAFirstSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCAFirstSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCAFirstSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
