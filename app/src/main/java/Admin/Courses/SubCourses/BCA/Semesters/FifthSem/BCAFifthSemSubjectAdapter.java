...
public class BCAFifthSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCAFifthSemSubjectAdapter.BCAFifthSemSubjectViewHolder> {

    String Role;
    public BCAFifthSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFifthSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCAFifthSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCAFifthSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCAFifthSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCAFifthSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
