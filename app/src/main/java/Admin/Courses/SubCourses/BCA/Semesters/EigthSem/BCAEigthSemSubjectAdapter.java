...
public class BCAEigthSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCAEigthSemSubjectAdapter.BCAEighthSemSubjectViewHolder> {

    String Role;
    public BCAEigthSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAEighthSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCAEighthSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCAEighthSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCAEighthSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCAEighthSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
