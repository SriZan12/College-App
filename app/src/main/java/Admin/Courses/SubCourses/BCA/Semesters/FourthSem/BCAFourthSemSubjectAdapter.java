...
public class BCAFourthSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCAFourthSemSubjectAdapter.BCAFourthSemSubjectViewHolder> {

    public BCAFourthSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFourthSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCAFourthSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCAFourthSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCAFourthSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCAFourthSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
