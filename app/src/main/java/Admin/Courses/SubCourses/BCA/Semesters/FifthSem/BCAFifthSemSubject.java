...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFifthSemSubjectBinding;
...
public class BCAFifthSemSubject extends Fragment {

    FragmentBCAFifthSemSubjectBinding subjectBinding;
    BCAFifthSemSubjectAdapter subjectAdapter;
    String Role;

    public BCAFifthSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subjectBinding =  FragmentBCAFifthSemSubjectBinding.inflate(inflater, container, false);

        subjectBinding.bcaFifthSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Fifth_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCAFifthSemSubjectAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaFifthSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaFifthSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            subjectBinding.bcaFifthSemStudent.setVisibility(View.GONE);
        }

        subjectBinding.bcaFifthSemStudent.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                Button done = dialog.findViewById(R.id.subjectDone);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Fifth_Sem").child("SubjectList")
                                .push()
                                .setValue(subDetails)
