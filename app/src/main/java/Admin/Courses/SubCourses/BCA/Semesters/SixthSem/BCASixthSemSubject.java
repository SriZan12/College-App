...
import com.example.relianceinternationalcollege.databinding.FragmentBCASixthSemSubjectBinding;
...
import Admin.Courses.SubCourses.BCA.Semesters.FifthSem.BCAFifthSemSubjectAdapter;


public class BCASixthSemSubject extends Fragment {

    FragmentBCASixthSemSubjectBinding subjectBinding;
    BCASixthSemSubjectAdapter subjectAdapter;
    String Role;

    public BCASixthSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         subjectBinding = FragmentBCASixthSemSubjectBinding.inflate(inflater, container, false);
        subjectBinding.bcaSixthSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Sixth_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCASixthSemSubjectAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaSixthSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaSixthSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            subjectBinding.bcaSixthSemStudent.setVisibility(View.GONE);
        }


        subjectBinding.bcaSixthSemStudent.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                Button done = dialog.findViewById(R.id.subjectDone);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Sixth_Sem").child("SubjectList")
                                .push()
                                .setValue(subDetails)
