...
public class BCASixthSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCASixthSemSubjectAdapter.BCASixthSemSubjectViewHolder> {

    String Role;

    public BCASixthSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASixthSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCASixthSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCASixthSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCASixthSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCASixthSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
