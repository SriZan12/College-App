...
import com.example.relianceinternationalcollege.databinding.FragmentBCASeventhSemSubjectBinding;
...
import Admin.Courses.SubCourses.BCA.Semesters.SixthSem.BCASixthSemSubjectAdapter;


public class BCASeventhSemSubject extends Fragment {

    FragmentBCASeventhSemSubjectBinding subjectBinding;
    BCASeventhSemSubjectAdapter subjectAdapter;
    String Role;

    public BCASeventhSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subjectBinding =  FragmentBCASeventhSemSubjectBinding.inflate(inflater, container, false);
        subjectBinding.bcaSeventhSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Seventh_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCASeventhSemSubjectAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaSeventhSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaSeventhSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            subjectBinding.bcaSeventhSemStudent.setVisibility(View.GONE);
        }


        subjectBinding.bcaSeventhSemStudent.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                Button done = dialog.findViewById(R.id.subjectDone);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Seventh_Sem").child("SubjectList")
                                .push()
                                .setValue(subDetails)
