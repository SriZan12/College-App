...
import com.example.relianceinternationalcollege.databinding.FragmentBCAEigthSemSubjectBinding;
...
import Admin.Courses.SubCourses.BCA.Semesters.SeventhSem.BCASeventhSemSubjectAdapter;


public class BCAEigthSemSubject extends Fragment {

    FragmentBCAEigthSemSubjectBinding subjectBinding;
    BCAEigthSemSubjectAdapter subjectAdapter;
    String Role;

    public BCAEigthSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subjectBinding =  FragmentBCAEigthSemSubjectBinding.inflate(inflater, container, false);
        subjectBinding.bcaEightSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Eight_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCAEigthSemSubjectAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaEightSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaEightSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            subjectBinding.bcaEightSemStudent.setVisibility(View.GONE);
        }

        subjectBinding.bcaEightSemStudent.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                Button done = dialog.findViewById(R.id.subjectDone);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Eight_Sem").child("SubjectList")
                                .push()
                                .setValue(subDetails)
