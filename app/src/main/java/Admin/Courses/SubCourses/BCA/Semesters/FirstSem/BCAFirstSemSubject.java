...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFirstSemSubjectBinding;
...
public class BCAFirstSemSubject extends Fragment {

    FragmentBCAFirstSemSubjectBinding subjectBinding;
    BCAFirstSemSubjectAdapter subjectAdapter;
    String Role;

    public BCAFirstSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subjectBinding =  FragmentBCAFirstSemSubjectBinding.inflate(inflater, container, false);
        subjectBinding.bcaFirsSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("First_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCAFirstSemSubjectAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaFirsSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaFirsSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            subjectBinding.bcaFirstSemStudent.setVisibility(View.GONE);
        }

        subjectBinding.bcaFirstSemStudent.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                Button done = dialog.findViewById(R.id.subjectDone);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("First_Sem").child("SubjectList")
                                .push()
                                .setValue(subDetails)
