...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFourthSemSubjectBinding;
...
import Admin.Courses.SubCourses.BCA.Semesters.ThirdSem.BCAThirdSemSubjectAdapter;


public class BCAFourthSemSubject extends Fragment {

    FragmentBCAFourthSemSubjectBinding subjectBinding;
    BCAFourthSemSubjectAdapter subjectAdapter;
    String Role;

    public BCAFourthSemSubject(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subjectBinding =  FragmentBCAFourthSemSubjectBinding.inflate(inflater, container, false);
        subjectBinding.bcaFourthSemRecycler.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<SubjectModel> options =
                new FirebaseRecyclerOptions.Builder<SubjectModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("subDetails").
                                child("BCA").child("Fourth_Sem").child("SubjectList"), SubjectModel.class)
                        .build();

        subjectAdapter = new BCAFourthSemSubjectAdapter(options);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        subjectBinding.bcaFourthSemRecycler.addItemDecoration(dividerItemDecoration);
        subjectBinding.bcaFourthSemRecycler.setAdapter(subjectAdapter);

        if(Role != null && Role.equals("TeacherStudent")) {

            subjectBinding.bcaFourthSemStudent.setVisibility(View.GONE);

        }
            subjectBinding.bcaFourthSemStudent.setOnClickListener(new View.OnClickListener() {
                @Override
                    ...
                    Button done = dialog.findViewById(R.id.subjectDone);
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("subDetails").
                                    child("BCA").child("Fourth_Sem").child("SubjectList")
                                    .push()
                                    .setValue(subDetails)
