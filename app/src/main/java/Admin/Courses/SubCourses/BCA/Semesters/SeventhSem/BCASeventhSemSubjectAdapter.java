...
public class BCASeventhSemSubjectAdapter extends FirebaseRecyclerAdapter<SubjectModel, BCASeventhSemSubjectAdapter.BCASeventhSemSubjectViewHolder> {

    String Role;
    public BCASeventhSemSubjectAdapter(@NonNull FirebaseRecyclerOptions<SubjectModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASeventhSemSubjectViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull SubjectModel model) {
    ...
    @NonNull
    @Override
    public BCASeventhSemSubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        SubjectDetailsBinding DetailsBinding = SubjectDetailsBinding.inflate(layoutInflater);
        return new BCASeventhSemSubjectViewHolder(DetailsBinding);
    }

    public static class BCASeventhSemSubjectViewHolder extends RecyclerView.ViewHolder {
        SubjectDetailsBinding DetailsBinding;
        public BCASeventhSemSubjectViewHolder(SubjectDetailsBinding subjectDetailsBinding) {
