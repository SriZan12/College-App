...
public class BCAEighthSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCAEighthSemFeesAdapter.BCAEighthSemFeesViewHolder> {

    String Role;

    public BCAEighthSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAEighthSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Eight_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAEighthSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCAEighthSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCAEighthSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCAEighthSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
