package Admin.Fees.BCAFees.EighthSemFees;
...
import com.example.relianceinternationalcollege.databinding.FragmentBCAEightSemFeesBinding;
...
public class BCAEightSemFees extends Fragment {

    FragmentBCAEightSemFeesBinding eightSemFeesBinding;
    BCAEighthSemFeesAdapter feesAdapter;
    String Role;

    public BCAEightSemFees(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        eightSemFeesBinding =  FragmentBCAEightSemFeesBinding.inflate(inflater, container, false);
        eightSemFeesBinding.bcaEightSemFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Eight_Sem"), FeesModel.class)
                        .build();

        feesAdapter = new BCAEighthSemFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        eightSemFeesBinding.bcaEightSemFees.addItemDecoration(dividerItemDecoration);
        eightSemFeesBinding.bcaEightSemFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            eightSemFeesBinding.bbsAddEightSemFees.setVisibility(View.GONE);
        }

        eightSemFeesBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        eightSemFeesBinding.bbsAddEightSemFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Eight_Sem").push().setValue(feesModel)
        ...
        return eightSemFeesBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BCAFees").child("Eight_Sem").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
