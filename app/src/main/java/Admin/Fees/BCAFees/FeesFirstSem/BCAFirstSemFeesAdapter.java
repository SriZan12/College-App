...
public class BCAFirstSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCAFirstSemFeesAdapter.BCAFirstSemFeesViewHolder> {

    String Role;

    public BCAFirstSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFirstSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("First_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAFirstSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     LayoutInflater inflater = LayoutInflater.from(parent.getContext());
     ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCAFirstSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCAFirstSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCAFirstSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
