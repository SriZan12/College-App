...
public class BCASecondSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCASecondSemFeesAdapter.BCASecondSemFeesViewHolder> {

    String Role;

    public BCASecondSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASecondSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Second_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCASecondSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCASecondSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCASecondSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCASecondSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
