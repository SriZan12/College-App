package Admin.Fees.BCAFees.FifthSemFees;
...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFifthSemFeesBinding;
...
public class BCAFifthSemFees extends Fragment {

    FragmentBCAFifthSemFeesBinding fifthSemFeesBinding;
    BCAFifthSemFeesAdapter feesAdapter;
    String Role;

    public BCAFifthSemFees(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fifthSemFeesBinding =  FragmentBCAFifthSemFeesBinding.inflate(inflater, container, false);
        fifthSemFeesBinding.bcaFifthSemFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Fifth_Sem"), FeesModel.class)
                        .build();

        feesAdapter = new BCAFifthSemFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        fifthSemFeesBinding.bcaFifthSemFees.addItemDecoration(dividerItemDecoration);
        fifthSemFeesBinding.bcaFifthSemFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            fifthSemFeesBinding.bcaAddfifthSemFees.setVisibility(View.GONE);
        }

        fifthSemFeesBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        fifthSemFeesBinding.bcaAddfifthSemFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Fifth_Sem").push().setValue(feesModel)
        ...
        return fifthSemFeesBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BCAFees").child("Fifth_Sem").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
