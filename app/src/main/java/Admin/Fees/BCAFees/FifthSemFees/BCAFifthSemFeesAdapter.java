...
public class BCAFifthSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCAFifthSemFeesAdapter.BCAFifthSemFeesViewHolder> {

    String Role;

    public BCAFifthSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFifthSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Fifth_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAFifthSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCAFifthSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCAFifthSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCAFifthSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
