...
public class BCASeventhSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCASeventhSemFeesAdapter.BCASeventhSemFeesViewHolder> {

    String Role;

    public BCASeventhSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASeventhSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Seventh_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCASeventhSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCASeventhSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCASeventhSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCASeventhSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
