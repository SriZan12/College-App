...
public class BCAFourthSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCAFourthSemFeesAdapter.BCAFourthSemFeesViewHolder> {

    String Role;

    public BCAFourthSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFourthSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Fourth_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAFourthSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCAFourthSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCAFourthSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCAFourthSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
