package Admin.Fees.BCAFees.FourthSem;
...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFourthSemFeesBinding;
...
public class BCAFourthSemFees extends Fragment {

    FragmentBCAFourthSemFeesBinding fourthSemFeesBinding;
    BCAFourthSemFeesAdapter feesAdapter;
    String Role;

    public BCAFourthSemFees(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fourthSemFeesBinding =  FragmentBCAFourthSemFeesBinding.inflate(inflater, container, false);
        fourthSemFeesBinding.bcaFourthSemFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Fourth_Sem"), FeesModel.class)
                        .build();

        feesAdapter = new BCAFourthSemFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        fourthSemFeesBinding.bcaFourthSemFees.addItemDecoration(dividerItemDecoration);
        fourthSemFeesBinding.bcaFourthSemFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            fourthSemFeesBinding.bcaAddFourthYearFees.setVisibility(View.GONE);
        }

        fourthSemFeesBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        fourthSemFeesBinding.bcaAddFourthYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Fourth_Sem").push().setValue(feesModel)
        ...
        return fourthSemFeesBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BCAFees").child("Fourth_Sem").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
