package Admin.Fees.BCAFees.ThirdSemFees;
...
import com.example.relianceinternationalcollege.databinding.FragmentBCAThirdSemFeesBinding;
...
public class BCAThirdSemFees extends Fragment {

    FragmentBCAThirdSemFeesBinding thirdSemFeesBinding;
    BCAThirdSemFeesAdapter feesAdapter;
    String Role;

    public BCAThirdSemFees(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        thirdSemFeesBinding =  FragmentBCAThirdSemFeesBinding.inflate(inflater, container, false);
        thirdSemFeesBinding.bcaThirdSemFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Third_Sem"), FeesModel.class)
                        .build();

        feesAdapter = new BCAThirdSemFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        thirdSemFeesBinding.bcaThirdSemFees.addItemDecoration(dividerItemDecoration);
        thirdSemFeesBinding.bcaThirdSemFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            thirdSemFeesBinding.bswAddThirdYearFees.setVisibility(View.GONE);
        }

        thirdSemFeesBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        thirdSemFeesBinding.bswAddThirdYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BCAFees").child("Third_Sem").push().setValue(feesModel)
        ...
        return thirdSemFeesBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BCAFees").child("Third_Sem").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
