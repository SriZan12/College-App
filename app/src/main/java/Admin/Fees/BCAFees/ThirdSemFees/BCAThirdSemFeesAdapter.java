...
public class BCAThirdSemFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BCAThirdSemFeesAdapter.BCAThirdSemFeesViewHolder> {

    String Role;

    public BCAThirdSemFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAThirdSemFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BCAFees").child("Third_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAThirdSemFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BCAThirdSemFeesViewHolder(showFeesBinding,Role);
    }

    public static class BCAThirdSemFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BCAThirdSemFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
