...
public class BSWSecondYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BSWSecondYearFeesAdapter.BSWSecondYearFeesViewHolder> {

    String Role;

    public BSWSecondYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWSecondYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BSWFees").child("Second_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWSecondYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BSWSecondYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BSWSecondYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BSWSecondYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
