package Admin.Fees.BSWFees.FirstYear;
...
import com.example.relianceinternationalcollege.databinding.FragmentBSWFeesFirstYearBinding;
...
public class BSWFeesFirstYear extends Fragment {

    FragmentBSWFeesFirstYearBinding bswFeesFirstYearBinding;
    BSWFirstYearFeesAdapter feesAdapter;
    String Role;

    public BSWFeesFirstYear(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bswFeesFirstYearBinding =  FragmentBSWFeesFirstYearBinding.inflate(inflater, container, false);
        bswFeesFirstYearBinding.bswFirstYearFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BSWFees").child("First_Year"), FeesModel.class)
                        .build();

        feesAdapter = new BSWFirstYearFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        bswFeesFirstYearBinding.bswFirstYearFees.addItemDecoration(dividerItemDecoration);
        bswFeesFirstYearBinding.bswFirstYearFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            bswFeesFirstYearBinding.bswAddFirstYearFees.setVisibility(View.GONE);
        }

        bswFeesFirstYearBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        bswFeesFirstYearBinding.bswAddFirstYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BSWFees").child("First_Year").push().setValue(feesModel)
        ...
        return bswFeesFirstYearBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BSWFees").child("First_Year").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
