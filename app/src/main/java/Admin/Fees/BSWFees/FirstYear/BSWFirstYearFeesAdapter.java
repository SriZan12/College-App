...
public class BSWFirstYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BSWFirstYearFeesAdapter.BSWFirstYearFeesViewHolder> {

    String Role;

    public BSWFirstYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWFirstYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BSWFees").child("First_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWFirstYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BSWFirstYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BSWFirstYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BSWFirstYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
