...
public class BSWThirdYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BSWThirdYearFeesAdapter.BSWThirdYearFeesViewHolder> {

    String Role;

    public BSWThirdYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWThirdYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BSWFees").child("Third_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWThirdYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BSWThirdYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BSWThirdYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BSWThirdYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
