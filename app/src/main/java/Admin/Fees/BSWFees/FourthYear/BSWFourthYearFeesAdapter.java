...
public class BSWFourthYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BSWFourthYearFeesAdapter.BSWFourthYearFeesViewHolder> {

    String Role;

    public BSWFourthYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWFourthYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BSWFees").child("Fourth_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWFourthYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BSWFourthYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BSWFourthYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BSWFourthYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
