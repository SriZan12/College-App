...
public class BBSThirdYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BBSThirdYearFeesAdapter.BBSThirdYearFeesViewHolder> {

    String Role;

    public BBSThirdYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSThirdYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BBSFees").child("Third_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSThirdYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BBSThirdYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BBSThirdYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BBSThirdYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
