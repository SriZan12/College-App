...
public class BBSSecondYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BBSSecondYearFeesAdapter.BBSSecondYearFeesViewHolder> {

    String Role;

    public BBSSecondYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSSecondYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BBSFees").child("Second_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSSecondYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BBSSecondYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BBSSecondYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BBSSecondYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
