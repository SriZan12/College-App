package Admin.Fees.BBSFees.SecondYear;
...
import com.example.relianceinternationalcollege.databinding.FragmentBBSFeesSecondYearBinding;
...
public class BBSFeesSecondYear extends Fragment {

    FragmentBBSFeesSecondYearBinding feesSecondYearBinding;
    BBSSecondYearFeesAdapter feesAdapter;
    String Role;

    public BBSFeesSecondYear(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feesSecondYearBinding =  FragmentBBSFeesSecondYearBinding.inflate(inflater, container, false);
        feesSecondYearBinding.bbsSecondYearFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("Second_Year"), FeesModel.class)
                        .build();

        feesAdapter = new BBSSecondYearFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        feesSecondYearBinding.bbsSecondYearFees.addItemDecoration(dividerItemDecoration);
        feesSecondYearBinding.bbsSecondYearFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            feesSecondYearBinding.bbsAddSecondYearFees.setVisibility(View.GONE);
        }
        ...
        feesSecondYearBinding.bbsAddSecondYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("Second_Year").push().setValue(feesModel)
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BBSFees").child("Second_Year").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
