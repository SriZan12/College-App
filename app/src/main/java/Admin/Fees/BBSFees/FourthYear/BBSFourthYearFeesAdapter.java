...
public class BBSFourthYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BBSFourthYearFeesAdapter.BBSFourthYearFeesViewHolder> {

    String Role;

    public BBSFourthYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSFourthYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BBSFees").child("Fourth_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSFourthYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BBSFourthYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BBSFourthYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BBSFourthYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
