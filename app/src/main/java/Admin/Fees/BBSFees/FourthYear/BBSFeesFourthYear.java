package Admin.Fees.BBSFees.FourthYear;
...
import com.example.relianceinternationalcollege.databinding.FragmentBBSFeesFourthYearBinding;
...
public class BBSFeesFourthYear extends Fragment {

    FragmentBBSFeesFourthYearBinding feesFourthYearBinding;
    BBSFourthYearFeesAdapter feesAdapter;
    String Role;

    public BBSFeesFourthYear(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feesFourthYearBinding =  FragmentBBSFeesFourthYearBinding.inflate(inflater, container, false);
        feesFourthYearBinding.bbsFourthYearFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("Fourth_Year"), FeesModel.class)
                        .build();

        feesAdapter = new BBSFourthYearFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        feesFourthYearBinding.bbsFourthYearFees.addItemDecoration(dividerItemDecoration);
        feesFourthYearBinding.bbsFourthYearFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            feesFourthYearBinding.bbsAddFourthYearFees.setVisibility(View.GONE);
        }
        ...
        feesFourthYearBinding.bbsAddFourthYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("Fourth_Year").push().setValue(feesModel)
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BBSFees").child("Fourth_Year").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
