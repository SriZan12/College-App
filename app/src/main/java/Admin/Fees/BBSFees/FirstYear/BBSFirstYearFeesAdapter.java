...
public class BBSFirstYearFeesAdapter extends FirebaseRecyclerAdapter<FeesModel, BBSFirstYearFeesAdapter.BBSFirstYearFeesViewHolder> {

    String Role;

    public BBSFirstYearFeesAdapter(@NonNull FirebaseRecyclerOptions<FeesModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSFirstYearFeesViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FeesModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("Fees")
                                    .child("BBSFees").child("First_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSFirstYearFeesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ShowFeesBinding showFeesBinding = ShowFeesBinding.inflate(inflater);
        return new BBSFirstYearFeesViewHolder(showFeesBinding,Role);
    }

    public static class BBSFirstYearFeesViewHolder extends RecyclerView.ViewHolder{
        ShowFeesBinding feesBinding;
        String Role;
        public BBSFirstYearFeesViewHolder(ShowFeesBinding showFeesBinding, String role) {
