package Admin.Fees.BBSFees.FirstYear;
...
import com.example.relianceinternationalcollege.databinding.FragmentBBSFeesFirstYearBinding;
...
public class BBSFeesFirstYear extends Fragment {

    FragmentBBSFeesFirstYearBinding feesFirstYearBinding;
    BBSFirstYearFeesAdapter feesAdapter;
    String Role;

    public BBSFeesFirstYear(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        feesFirstYearBinding =  FragmentBBSFeesFirstYearBinding.inflate(inflater, container, false);
        feesFirstYearBinding.bbsFirstYearFees.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<FeesModel> options =
                new FirebaseRecyclerOptions.Builder<FeesModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("First_Year"), FeesModel.class)
                        .build();

        feesFirstYearBinding.searchStudent.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
        ...
        feesAdapter = new BBSFirstYearFeesAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        feesFirstYearBinding.bbsFirstYearFees.addItemDecoration(dividerItemDecoration);
        feesFirstYearBinding.bbsFirstYearFees.setAdapter(feesAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            feesFirstYearBinding.bbsAddfirstYearFees.setVisibility(View.GONE);
        }

        feesFirstYearBinding.bbsAddfirstYearFees.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Fees")
                                .child("BBSFees").child("First_Year").push().setValue(feesModel)
        ...
        return feesFirstYearBinding.getRoot();
    }
    ...
    private void searchNote(String query) {
        FirebaseRecyclerOptions<FeesModel> options = new FirebaseRecyclerOptions.Builder<FeesModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Fees").
                        child("BBSFees").child("First_Year").orderByChild("lowercaseStudentName").startAt(query.toLowerCase()).endAt(query+"\uff8ff"), FeesModel.class)
                .build();
