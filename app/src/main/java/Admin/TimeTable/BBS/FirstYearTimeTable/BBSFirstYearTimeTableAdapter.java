...
public class BBSFirstYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BBSFirstYearTimeTableAdapter.BBSFirstYearTimeTableViewHolder> {

    String Role;

    public BBSFirstYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSFirstYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BBSTimeTable").child("First_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSFirstYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
       TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BBSFirstYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BBSFirstYearTimeTableViewHolder extends RecyclerView.ViewHolder{
      TimetableDesignBinding timetableDesignBinding;
      String Role;
        public BBSFirstYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
