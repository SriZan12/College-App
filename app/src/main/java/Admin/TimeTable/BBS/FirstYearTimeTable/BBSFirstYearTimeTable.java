package Admin.TimeTable.BBS.FirstYearTimeTable;
...
import com.example.relianceinternationalcollege.databinding.FragmentBBSFirstYearTimeTableBinding;
import com.firebase.ui.database.FirebaseRecyclerOptions;
import com.google.android.gms.tasks.OnFailureListener;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.firebase.database.FirebaseDatabase;

import Admin.Fees.BBSFees.FirstYear.BBSFirstYearFeesAdapter;
import Admin.Fees.FeesModel;
import Admin.TimeTable.TimeTableModel;


public class BBSFirstYearTimeTable extends Fragment {

    FragmentBBSFirstYearTimeTableBinding timeTableBinding;
    BBSFirstYearTimeTableAdapter timeTableAdapter;
    String Role;

    public BBSFirstYearTimeTable(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timeTableBinding =  FragmentBBSFirstYearTimeTableBinding.inflate(inflater, container, false);
        timeTableBinding.bbsFirstYearTimeTable.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<TimeTableModel> options =
                new FirebaseRecyclerOptions.Builder<TimeTableModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                .child("BBSTimeTable").child("First_Year"), TimeTableModel.class)
                        .build();


        timeTableAdapter = new BBSFirstYearTimeTableAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        timeTableBinding.bbsFirstYearTimeTable.addItemDecoration(dividerItemDecoration);
        timeTableBinding.bbsFirstYearTimeTable.setAdapter(timeTableAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            timeTableBinding.bbsAddFirstYearTimeTable.setVisibility(View.GONE);
        }

        timeTableBinding.bbsAddFirstYearTimeTable.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                .child("BBSTimeTable").child("First_Year").push().setValue(timeTableModel)
