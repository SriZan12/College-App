...
public class BBSThirdYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BBSThirdYearTimeTableAdapter.BBSThirdYearTimeTableViewHolder> {

    String Role;

    public BBSThirdYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSThirdYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BBSTimeTable").child("Third_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSThirdYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BBSThirdYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BBSThirdYearTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BBSThirdYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
