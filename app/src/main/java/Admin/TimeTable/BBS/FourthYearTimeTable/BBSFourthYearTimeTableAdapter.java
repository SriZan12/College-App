...
public class BBSFourthYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BBSFourthYearTimeTableAdapter.BBSFourthYearTimeTableViewHolder> {

    String Role;

    public BBSFourthYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSFourthYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BBSTimeTable").child("Fourth_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSFourthYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BBSFourthYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BBSFourthYearTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BBSFourthYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
