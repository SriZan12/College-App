...
public class BBSSecondYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BBSSecondYearTimeTableAdapter.BBSSecondYearTimeTableViewHolder> {

    String Role;
    public BBSSecondYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BBSSecondYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BBSTimeTable").child("Second_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BBSSecondYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BBSSecondYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BBSSecondYearTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BBSSecondYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
