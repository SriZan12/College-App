...
public class BSWSecondYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BSWSecondYearTimeTableAdapter.BSWSecondYearTimeTableViewHolder> {

    String Role;

    public BSWSecondYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWSecondYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BSWTimeTable").child("Second_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWSecondYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BSWSecondYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BSWSecondYearTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BSWSecondYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
