...
public class BSWFourthYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BSWFourthYearTimeTableAdapter.BSWFourthYearTimeTableViewHolder> {

    String Role;
    public BSWFourthYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWFourthYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BSWTimeTable").child("Fourth_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWFourthYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BSWFourthYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BSWFourthYearTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BSWFourthYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
