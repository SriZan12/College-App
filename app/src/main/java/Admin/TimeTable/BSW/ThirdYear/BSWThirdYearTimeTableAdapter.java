...
public class BSWThirdYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BSWThirdYearTimeTableAdapter.BSWThirdYearTimeTableViewHolder> {

    String Role;

    public BSWThirdYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWThirdYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BSWTimeTable").child("Third_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWThirdYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BSWThirdYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BSWThirdYearTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BSWThirdYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
