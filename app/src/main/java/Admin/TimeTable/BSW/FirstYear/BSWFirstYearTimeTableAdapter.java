...
public class BSWFirstYearTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BSWFirstYearTimeTableAdapter.BSWFirstYearTimeTableViewHolder> {

    String Role;
    public BSWFirstYearTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BSWFirstYearTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BSWTimeTable").child("First_Year").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BSWFirstYearTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BSWFirstYearTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BSWFirstYearTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BSWFirstYearTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
