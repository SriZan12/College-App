...
public class BCAFirstSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCAFirstSemTimeTableAdapter.BCAFirstSemTimeTableViewHolder> {

    String Role;
    public BCAFirstSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFirstSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("First_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAFirstSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCAFirstSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCAFirstSemTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BCAFirstSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
