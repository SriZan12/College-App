...
import com.example.relianceinternationalcollege.databinding.FragmentBCAFourthSemTimeTableBinding;
import com.firebase.ui.database.FirebaseRecyclerOptions;
import com.google.android.gms.tasks.OnFailureListener;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.firebase.database.FirebaseDatabase;

import Admin.TimeTable.BCA.FirstSemTimeTable.BCAFirstSemTimeTableAdapter;
import Admin.TimeTable.TimeTableModel;


public class BCA_FourthSem_TimeTable extends Fragment {

    FragmentBCAFourthSemTimeTableBinding timeTableBinding;
    BCAFourthSemTimeTableAdapter timeTableAdapter;
    String Role;

    public BCA_FourthSem_TimeTable(String role) {
        this.Role = role;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timeTableBinding =  FragmentBCAFourthSemTimeTableBinding.inflate(inflater, container, false);
        timeTableBinding.bcaFourthSemTimeTable.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<TimeTableModel> options =
                new FirebaseRecyclerOptions.Builder<TimeTableModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                .child("BCATimeTable").child("Fourth_Sem"), TimeTableModel.class)
                        .build();


        timeTableAdapter = new BCAFourthSemTimeTableAdapter(options,Role);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(getContext(),
                DividerItemDecoration.VERTICAL);
        timeTableBinding.bcaFourthSemTimeTable.addItemDecoration(dividerItemDecoration);
        timeTableBinding.bcaFourthSemTimeTable.setAdapter(timeTableAdapter);

        if(Role != null && Role.equals("TeacherStudent")){
            timeTableBinding.bcaAddFourthSemTimeTable.setVisibility(View.GONE);
        }

        timeTableBinding.bcaAddFourthSemTimeTable.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                .child("BCATimeTable").child("Fourth_Sem").push().setValue(timeTableModel)
