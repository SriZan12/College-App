...
public class BCAThirdSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCAThirdSemTimeTableAdapter.BCAThirdSemTimeTableViewHolder> {

    String Role;
    public BCAThirdSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAThirdSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Third_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAThirdSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCAThirdSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCAThirdSemTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BCAThirdSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
