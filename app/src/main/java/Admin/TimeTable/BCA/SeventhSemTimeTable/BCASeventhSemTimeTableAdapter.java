...
public class BCASeventhSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCASeventhSemTimeTableAdapter.BCASeventhSemTimeTableViewHolder> {

    String Role;

    public BCASeventhSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASeventhSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Seventh_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCASeventhSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCASeventhSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCASeventhSemTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BCASeventhSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
