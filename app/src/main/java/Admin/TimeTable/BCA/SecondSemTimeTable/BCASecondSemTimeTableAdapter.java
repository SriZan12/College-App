...
public class BCASecondSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCASecondSemTimeTableAdapter.BCASecondSemTimeTableViewHolder> {

    String Role;
    public BCASecondSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASecondSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Second_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCASecondSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCASecondSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCASecondSemTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BCASecondSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
