...
public class BCASixthSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCASixthSemTimeTableAdapter.BCASixthSemTimeTableViewHolder> {

    String Role;
    public BCASixthSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCASixthSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Sixth_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCASixthSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCASixthSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCASixthSemTimeTableViewHolder extends RecyclerView.ViewHolder{

        TimetableDesignBinding timetableDesignBinding;
        String Role;

        public BCASixthSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
