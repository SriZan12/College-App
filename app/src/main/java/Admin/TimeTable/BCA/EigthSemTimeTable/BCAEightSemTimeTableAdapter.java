...
public class BCAEightSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCAEightSemTimeTableAdapter.BCAEightSemTimeTableViewHolder> {

    String Role;
    public BCAEightSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAEightSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Eight_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAEightSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCAEightSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCAEightSemTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BCAEightSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
