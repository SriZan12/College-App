...
public class BCAFifthSemTimeTableAdapter extends FirebaseRecyclerAdapter<TimeTableModel, BCAFifthSemTimeTableAdapter.BCAFifthSemTimeTableViewHolder> {

    String Role;

    public BCAFifthSemTimeTableAdapter(@NonNull FirebaseRecyclerOptions<TimeTableModel> options, String role) {
        super(options);
        this.Role = role;
    }

    @Override
    protected void onBindViewHolder(@NonNull BCAFifthSemTimeTableViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TimeTableModel model) {
                    ...
                    doneButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("TimeTable")
                                    .child("BCATimeTable").child("Fifth_Sem").child(getRef(position).getKey())
    ...
    @NonNull
    @Override
    public BCAFifthSemTimeTableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        TimetableDesignBinding timetableDesignBinding = TimetableDesignBinding.inflate(inflater);
        return new BCAFifthSemTimeTableViewHolder(timetableDesignBinding,Role);
    }

    public static class BCAFifthSemTimeTableViewHolder extends RecyclerView.ViewHolder{
        TimetableDesignBinding timetableDesignBinding;
        String Role;
        public BCAFifthSemTimeTableViewHolder(TimetableDesignBinding timeTable, String role) {
