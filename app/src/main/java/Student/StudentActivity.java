...
import com.example.relianceinternationalcollege.databinding.ActivityStudentBinding;
...
public class StudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentBinding.text2.setText("Student");
        ...
        if (firebaseUser != null) {
            if (firebaseUser.getPhotoUrl() != null) {
                Glide.with(this)
                        ...
                        .into(studentBinding.StudentProfilePic);
            }
            if (firebaseUser.getDisplayName() != null) {
                studentBinding.name.setText(firebaseUser.getDisplayName());
            }
        }


        studentBinding.courses.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, CoursesListActivity.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });

        studentBinding.notes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, NotesActivity.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });

        studentBinding.Event.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, Event.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });

        studentBinding.fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, Fees.class);
                intent.putExtra("role",role);
                startActivity(intent);
        ...
        studentBinding.library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, LibraryActivity.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });

        studentBinding.leaveNote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(StudentActivity.this, LeaveNoteActivity.class));
            }
        });

        studentBinding.timeTable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, TimeTableActivity.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });

        studentBinding.gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(StudentActivity.this, Gallery.class));
            }
        });
            ...
            FirebaseDatabase.getInstance().getReference().child("LeaveNotes").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if(Count.equals("0") || Count.isEmpty()) {
                        studentBinding.totalLeave.setVisibility(View.GONE);
                    }else{
                        studentBinding.totalLeave.setVisibility(View.VISIBLE);
                        studentBinding.totalLeave.setText(Count);
                    }
                }
        ...
        studentBinding.StudentProfilePic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                doneButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        studentBinding.StudentProfilePic.setImageURI(filepath);
                        ...
                        user.updateProfile(request).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                studentBinding.name.setText(Name);
        ...
        studentBinding.attendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(StudentActivity.this, Attendance.class);
                intent.putExtra("role",role);
                startActivity(intent);
            }
        });
    ...
    private void UpdateNameTOFirebase(String Name, FirebaseUser user) {
        ...
        FirebaseDatabase.getInstance().getReference().child("ProfileName").child(firebaseAuth.getCurrentUser().getDisplayName())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(StudentActivity.this, "Name Updated !!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void RequestPermission() {
        if(ActivityCompat.shouldShowRequestPermissionRationale(StudentActivity.this,Manifest.permission.READ_EXTERNAL_STORAGE)){
            ...
            ActivityCompat.requestPermissions(StudentActivity.this,new
